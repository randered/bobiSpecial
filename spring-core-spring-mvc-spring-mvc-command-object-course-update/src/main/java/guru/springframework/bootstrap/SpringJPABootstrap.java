...
public class SpringJPABootstrap implements ApplicationListener<ContextRefreshedEvent>{
    ...
    public void loadUsersAndCustomers() {
        ...
        customer1.setBillingAddress(new Address("1 Key Biscane Ave", "1 Key Biscane Ave", "Miami","Florida","33101" ));
...
//        customer1.getBillingAddress().setZipCode("33101");
        ...
        customer2.setBillingAddress(new Address("1 Key Biscane Ave", "1 Key Biscane Ave", "Miami","Florida","33101" ));
